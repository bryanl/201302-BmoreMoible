 ...
 */
public class QuoteDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(QuoteDetailFragment.ARG_ITEM_ID, getIntent()
                    .getStringExtra(QuoteDetailFragment.ARG_ITEM_ID));
